...
Source0  : https://files.pythonhosted.org/packages/61/8c/df09d4ab646141f130f9977b32b206ba8615d1969b2eba6a2e84b7f89137/jupyter_server-2.15.0.tar.gz
...
%prep
%setup -q -n jupyter_server-2.15.0
cd %{_builddir}/jupyter_server-2.15.0
pushd ..
cp -a jupyter_server-2.15.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1735096796
