...
Source0  : https://files.pythonhosted.org/packages/c4/b3/74a5c89d151a7f20a3b390cc2ecba84f7ba49ffb36bd5c73b0a2a320a84a/jupyter_server-1.17.1.tar.gz
...
%prep
%setup -q -n jupyter_server-1.17.1
cd %{_builddir}/jupyter_server-1.17.1
pushd ..
cp -a jupyter_server-1.17.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1654700351
...
cp %{_builddir}/jupyter_server-1.17.1/COPYING.md %{buildroot}/usr/share/package-licenses/pypi-jupyter_server/8fd549f28c3423c251b3b70e91bdad2fbfe6ef30
