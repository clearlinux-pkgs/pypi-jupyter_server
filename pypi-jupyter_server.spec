...
Source0  : https://files.pythonhosted.org/packages/41/c8/ba2bbcd758c47f1124c4ca14061e8ce60d9c6fd537faee9534a95f83521a/jupyter_server-2.16.0.tar.gz
...
%prep
%setup -q -n jupyter_server-2.16.0
cd %{_builddir}/jupyter_server-2.16.0
pushd ..
cp -a jupyter_server-2.16.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1747076131
