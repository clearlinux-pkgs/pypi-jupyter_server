...
Source0  : https://files.pythonhosted.org/packages/bc/0b/59dadee82f0c7d960e2a8691dc1bce0ff7dbfde107993aadfb0ff87f9763/jupyter_server-1.19.1.tar.gz
...
%prep
%setup -q -n jupyter_server-1.19.1
cd %{_builddir}/jupyter_server-1.19.1
pushd ..
cp -a jupyter_server-1.19.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1664327361
