...
Source0  : https://files.pythonhosted.org/packages/0f/d2/d33f95f779e113c02f7a2c48dbaca3d47597979bb8a53b05b667f733ff59/jupyter_server-1.17.0.tar.gz
...
%prep
%setup -q -n jupyter_server-1.17.0
cd %{_builddir}/jupyter_server-1.17.0
pushd ..
cp -a jupyter_server-1.17.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1653340558
...
cp %{_builddir}/jupyter_server-1.17.0/COPYING.md %{buildroot}/usr/share/package-licenses/pypi-jupyter_server/8fd549f28c3423c251b3b70e91bdad2fbfe6ef30
