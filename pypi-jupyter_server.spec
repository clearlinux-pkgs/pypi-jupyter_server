...
Version  : 1.13.4
Release  : 38
URL      : https://files.pythonhosted.org/packages/d8/81/beb9e78fccc149b0aaa1e53a329f738e2683e2319fe56922b481d907eda9/jupyter_server-1.13.4.tar.gz
Source0  : https://files.pythonhosted.org/packages/d8/81/beb9e78fccc149b0aaa1e53a329f738e2683e2319fe56922b481d907eda9/jupyter_server-1.13.4.tar.gz
...
%prep
%setup -q -n jupyter_server-1.13.4
cd %{_builddir}/jupyter_server-1.13.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1643042449
...
cp %{_builddir}/jupyter_server-1.13.4/COPYING.md %{buildroot}/usr/share/package-licenses/pypi-jupyter_server/8fd549f28c3423c251b3b70e91bdad2fbfe6ef30
