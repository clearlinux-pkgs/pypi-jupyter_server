...
Version  : 1.23.2
Release  : 60
URL      : https://files.pythonhosted.org/packages/56/1a/8aa0f15c8aea50ef8235a56e5a823a4a25f03f23806a0ecaf12d25f3ce21/jupyter_server-1.23.2.tar.gz
Source0  : https://files.pythonhosted.org/packages/56/1a/8aa0f15c8aea50ef8235a56e5a823a4a25f03f23806a0ecaf12d25f3ce21/jupyter_server-1.23.2.tar.gz
...
%prep
%setup -q -n jupyter_server-1.23.2
cd %{_builddir}/jupyter_server-1.23.2
pushd ..
cp -a jupyter_server-1.23.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1668448149
