...
Source0  : https://files.pythonhosted.org/packages/0c/34/88b47749c7fa9358e10eac356c4b97d94a91a67d5c935a73f69bc4a31118/jupyter_server-2.14.2.tar.gz
...
%prep
%setup -q -n jupyter_server-2.14.2
cd %{_builddir}/jupyter_server-2.14.2
pushd ..
cp -a jupyter_server-2.14.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1721061850
