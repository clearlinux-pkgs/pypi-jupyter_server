...
Source0  : https://files.pythonhosted.org/packages/94/1f/b459045b6a4c4c94a461cbf14026c15153baaf3116402a3db1744c8416de/jupyter_server-1.16.0.tar.gz
...
%prep
%setup -q -n jupyter_server-1.16.0
cd %{_builddir}/jupyter_server-1.16.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1650737842
...
cp %{_builddir}/jupyter_server-1.16.0/COPYING.md %{buildroot}/usr/share/package-licenses/pypi-jupyter_server/8fd549f28c3423c251b3b70e91bdad2fbfe6ef30
