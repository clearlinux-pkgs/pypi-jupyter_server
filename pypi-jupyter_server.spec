...
Source0  : https://files.pythonhosted.org/packages/17/70/9f98505763c6cf2244163fd58441f95f80a3677f8a09bc9908ba21685e45/jupyter_server-1.13.1.tar.gz
...
Provides: jupyter_server
Provides: jupyter_server-python
Provides: jupyter_server-python3
...
%prep
%setup -q -n jupyter_server-1.13.1
cd %{_builddir}/jupyter_server-1.13.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1641451654
...
cp %{_builddir}/jupyter_server-1.13.1/COPYING.md %{buildroot}/usr/share/package-licenses/pypi-jupyter_server/8fd549f28c3423c251b3b70e91bdad2fbfe6ef30
