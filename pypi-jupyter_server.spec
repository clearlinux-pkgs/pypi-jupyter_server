...
Version  : 1.23.1
Release  : 59
URL      : https://files.pythonhosted.org/packages/0c/f4/8368f8ecc6ca1b7da8dfb0bd61b20ea03c2b2470f9d7b2ba94a9ba3488ef/jupyter_server-1.23.1.tar.gz
Source0  : https://files.pythonhosted.org/packages/0c/f4/8368f8ecc6ca1b7da8dfb0bd61b20ea03c2b2470f9d7b2ba94a9ba3488ef/jupyter_server-1.23.1.tar.gz
Summary  : =?utf-8?q?The_backend=E2=80=94i=2Ee=2E_core_services=2C_APIs=2C_and_REST_endpoints=E2=80=94to_Jupyter_web_applications=2E?=
...
%prep
%setup -q -n jupyter_server-1.23.1
cd %{_builddir}/jupyter_server-1.23.1
pushd ..
cp -a jupyter_server-1.23.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1668096606
...
cp %{_builddir}/jupyter_server-%{version}/COPYING.md %{buildroot}/usr/share/package-licenses/pypi-jupyter_server/8fd549f28c3423c251b3b70e91bdad2fbfe6ef30 || :
