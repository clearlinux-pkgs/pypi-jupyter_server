...
Source0  : https://files.pythonhosted.org/packages/60/5c/a036a51ef7f3f1f5890bed5a3b4bc20ab4f25e4a39aa0e1214ba18f9ebc0/jupyter_server-1.23.0.tar.gz
...
%prep
%setup -q -n jupyter_server-1.23.0
cd %{_builddir}/jupyter_server-1.23.0
pushd ..
cp -a jupyter_server-1.23.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1667843579
