...
Version  : 1.18.0
Release  : 45
URL      : https://files.pythonhosted.org/packages/0e/63/d8c87009e0254ae44bb4c70fe73934fd19a4a18444132d04c025c5d8b730/jupyter_server-1.18.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/0e/63/d8c87009e0254ae44bb4c70fe73934fd19a4a18444132d04c025c5d8b730/jupyter_server-1.18.0.tar.gz
...
%prep
%setup -q -n jupyter_server-1.18.0
cd %{_builddir}/jupyter_server-1.18.0
pushd ..
cp -a jupyter_server-1.18.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1656096967
...
cp %{_builddir}/jupyter_server-1.18.0/COPYING.md %{buildroot}/usr/share/package-licenses/pypi-jupyter_server/8fd549f28c3423c251b3b70e91bdad2fbfe6ef30
