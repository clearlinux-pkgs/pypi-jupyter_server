...
Source0  : https://files.pythonhosted.org/packages/ff/e0/7fc708fe05d7071fc13c93e02805594aa468a46dfa19fdf04d5f1712ac2a/jupyter_server-2.13.0.tar.gz
...
%prep
%setup -q -n jupyter_server-2.13.0
cd %{_builddir}/jupyter_server-2.13.0
pushd ..
cp -a jupyter_server-2.13.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1709568918
