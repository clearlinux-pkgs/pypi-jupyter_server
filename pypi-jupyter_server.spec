...
Source0  : https://files.pythonhosted.org/packages/a8/17/f01e391b6299969a8d1d1aae7bdf40e284126a31147f5475325a90aadfa2/jupyter_server-2.14.1.tar.gz
...
%prep
%setup -q -n jupyter_server-2.14.1
cd %{_builddir}/jupyter_server-2.14.1
pushd ..
cp -a jupyter_server-2.14.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1717432487
