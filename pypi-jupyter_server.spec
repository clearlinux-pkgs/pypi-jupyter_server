...
Source0  : https://files.pythonhosted.org/packages/d8/e5/9fc8797923798c9d3ce16935fe059dd210eca8596da8d788119cc36f6156/jupyter_server-1.13.2.tar.gz
...
%prep
%setup -q -n jupyter_server-1.13.2
cd %{_builddir}/jupyter_server-1.13.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1642030696
...
cp %{_builddir}/jupyter_server-1.13.2/COPYING.md %{buildroot}/usr/share/package-licenses/pypi-jupyter_server/8fd549f28c3423c251b3b70e91bdad2fbfe6ef30
