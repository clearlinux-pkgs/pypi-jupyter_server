...
Source0  : https://files.pythonhosted.org/packages/23/d8/1534559049389928ba8abfd4b9ff544e43e4a14d91b42a09f9f4b56c18df/jupyter_server-2.14.0.tar.gz
...
%prep
%setup -q -n jupyter_server-2.14.0
cd %{_builddir}/jupyter_server-2.14.0
pushd ..
cp -a jupyter_server-2.14.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1712937005
