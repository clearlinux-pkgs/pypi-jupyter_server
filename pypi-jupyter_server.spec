...
Version  : 1.19.0
Release  : 50
URL      : https://files.pythonhosted.org/packages/fb/dd/86ad023acda359a963cbdc04c978e89a46e1c9dd08259608a3bed3be15f4/jupyter_server-1.19.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/fb/dd/86ad023acda359a963cbdc04c978e89a46e1c9dd08259608a3bed3be15f4/jupyter_server-1.19.0.tar.gz
...
%prep
%setup -q -n jupyter_server-1.19.0
cd %{_builddir}/jupyter_server-1.19.0
pushd ..
cp -a jupyter_server-1.19.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1664231421
