...
Source0  : https://files.pythonhosted.org/packages/fd/4f/38cfdca7fa3a2185cbe90548e6b605c8436bd418f3f40a3fdaa81dcfedfe/jupyter_server-2.12.0.tar.gz
...
%prep
%setup -q -n jupyter_server-2.12.0
cd %{_builddir}/jupyter_server-2.12.0
pushd ..
cp -a jupyter_server-2.12.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1701899283
